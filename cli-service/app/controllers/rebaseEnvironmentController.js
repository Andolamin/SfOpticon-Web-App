/**
 * Rebase an environment from production
 * (i.e. merge all new production deployments into the environment)
 *
...
function RebaseEnvironmentsController() {
    ...
    this.commandType = 'Rebase Environment';
};

RebaseEnvironmentsController.prototype = new CommandController();

RebaseEnvironmentsController.prototype.handleJob = function handleJob() {
    ...
    child.on('exit', function() {
        ...
        if (this.lastProgress >= 0 && this.lastProgress < this.progressDef.length - 1 && this.progressDef[this.lastProgress].progress < 100) {
...
module.exports = RebaseEnvironmentsController;